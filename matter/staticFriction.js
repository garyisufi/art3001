...
Example.staticFriction = function() {
    ...
    var render = Render.create({
        element: document.getElementById("matter-staticFriction"),
        engine: engine,
        options: {
            width: 600,
            height: 400,
    ...
    // add bodies
    var body = Bodies.rectangle(400, 500, 200, 60, { isStatic: true, chamfer: 10, render: { fillStyle: '#152238' } }),
        size = 50,
        counter = -1;
